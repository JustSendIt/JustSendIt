...
**You can make an account with an invite ticket (§3.16) and nothing but an email.** No wallet, no signature, no coins. You pick your **@username** in the same form — it is your public name, and you can sign in with it or your email. You can read every page, check in daily, keep your Send Power decay at bay, and set up your own profile (name, bio, colours, links) — that earns no points until you pass the check below, but nothing stops you making the page yours. Pictures are uploads like any other and wait for the check.
